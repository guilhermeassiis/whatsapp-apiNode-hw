...
var Sender = /** @class */ (function () {
    ...
    Sender.prototype.initialize = function () {
        var _this = this;
        var qr = function (base64Qr, asciiQR, attemps) {
            _this.qr = { base64Qr: base64Qr, asciiQR: asciiQR, attemps: attemps };
        };
        var status = function (statusSession) {
            _this.connected = !(["isLogged", "qrReadSuccess", "chatsAvaible", "connectBrowserWs", "initWhatsapp", "successChat"].includes(statusSession));
        };
        var start = function (client) {
            _this.client = client;
        };
        (0, venom_bot_1.create)('wpp-save-hw', qr, status)
